 ...
 * Modified with slower decay priors - fitness should persist longer.
 *
...
model {
  // Prior for decay without training - SLOWER DECAY
  // Beta(8, 2) centers around 0.8, with most mass above 0.6
  alpha_d ~ beta(8, 2);
  ...
  beta ~ exponential(1);              // mean=1.0 (more gain per intensity)
