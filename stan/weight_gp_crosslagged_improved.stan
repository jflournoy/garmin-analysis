/*
 * Improved cross-lagged Gaussian Process model for weight and workouts.
...
parameters {
  ...
  real<lower=-4.605, upper=1.609> log_alpha_weight; // Log marginal std for weight
  real<lower=-4.605, upper=1.609> log_rho_weight;   // Log length scale for weight
  real<lower=-4.605, upper=1.609> log_alpha_workout; // Log marginal std for workouts
  real<lower=-4.605, upper=1.609> log_rho_workout;  // Log length scale for workouts
