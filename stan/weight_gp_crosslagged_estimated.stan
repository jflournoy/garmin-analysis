/*
 * Cross-lagged Gaussian Process model with estimated lag parameter.
...
model {
  ...
  // Prior for lag (days) - exponential with mean 3 days
  // Most workout effects expected within 0-7 days
  lag_days ~ exponential(1.0 / 3.0);  // mean = 3 days
